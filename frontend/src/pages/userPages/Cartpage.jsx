...
const Cartpage = () => {
  ...
  return (
    <div className="containerBox">
      <section className="py-15 mt-10 relative">
        <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
          <h2 className="title font-manrope font-bold text-4xl leading-10 mb-8 text-center text-gray-500">
            Shopping Cart
          </h2>
          ...
          <div className="flex items-center justify-center mb-8">
            <Link
              to="/shipping"
              className="rounded-2xl w-full max-w-[450px] py-4 text-center justify-center items-center bg-[#7f6ab0] font-semibold text-lg text-white flex transition-all duration-500 hover:bg-[#4c3d70]"
            >
              Proceed To Checkout
            </Link>
          </div>
